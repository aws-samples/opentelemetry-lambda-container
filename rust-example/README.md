# Tracing Rust-based containerized Lambda with X-Ray and OpenTelemetry

In this example, we integrate OpenTelemetry Collector as a Lambda extension to collect and export trace data to AWS X-Ray. The actual Lambda function, written in Rust, analyzes images stored on Amazon S3 using Amazon Rekognition.
...
cd opentelemetry-lambda-container/rust-example
